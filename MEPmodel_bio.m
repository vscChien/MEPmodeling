...
function ref = update_model_bio(ref,p)
    ...
    %----- Motor neuron -----
    ref.model.tauLIF    = 10;   % ms
    ref.model.Eexc      = 0;    % mV
    ref.model.Einh      = -75;  % mV
    ref.model.V_rest    = -65;  % mV
    ref.model.V_thr     = -55;  % mV
    ref.model.T_ref     = 2;    % ms, refractory period
    ref.model.fastAChRweight = 0.5; % AchR (MN->RC)
