function plot_summary(p,ref)
    ...
    if ref.model.withRC
        ...
        text(30,ylimit(2)*0.55,sprintf('v0= %g',round(p(10),1)),...
             'color','k','fontsize',7,'FontName', 'calibri','BackgroundColor','none')
    end
    ...
    text(30,ylimit(2)*0.35,sprintf('TMU= %g',round(ref.model.Tmu,1)),...
        'color','k','fontsize',7,'FontName', 'calibri','BackgroundColor','none')
    text(15,ylimit(2)*0.95,'\alpha',...
        'color','k','fontsize',7,'BackgroundColor','none','Interpreter','tex')
    text(15+8, ylimit(2)*0.95, sprintf('AMPA= %g', round(ref.model.AMPAweight,1)), ...
    'Color','k', 'FontSize',7, 'FontName','Calibri','BackgroundColor','none')
